...
const ForgetPasswordModal = ({ handleModalShow }) => {
  ...
  const forgetStudentPassword = () => {
    ...
    dispatch(ForgetPassword(body))
      ...
      .then(() => {
        setLoading(false);
        setEmailSent(true); // Set emailSent to true after successful submission
        toast.success("A password reset link has been sent to your email."); // Display success toast
        setTimeout(() => {
